      ...
      <div className="cartPageWrapper" >
        <div className="cartHeader">
          <div className="layout align-center cartHeaderTop">
            <img src={'/psl_static/icons/back.svg'} class="iconNew " onClick={()=>this.props.history.push('/')} />
          </div>
        </div>
        ...
        <div className={classnames("cart-preview cartDesign layout", 'showcartpreview')}>
          <div onClick={!!cart_items && !!cart_items.length ? ()=>console.log('place order') : ()=>this.props.history.push('/')} className="layout justify-center align-center">
